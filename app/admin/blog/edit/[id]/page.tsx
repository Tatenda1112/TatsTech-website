...
import { ArrowLeft, Save, Eye, Image, Tag, Folder, Star, Trash2, Type } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="inline-flex items-center gap-2 bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors font-medium min-h-[44px] touch-manipulation"
              >
                <Trash2 size={18} />
                Delete
              </button>
